...
void eye(int lighter_eyecolor, int mid_eyecolor, int darker_eyecolor,
  ...
  arc( eye_center, 
       ...
       eye_X,   
       eye_Y - anime_var, 
       3*PI/2 + (float)anime_var/(eye_size/4),
       3*PI + PI/2 - (float)anime_var/(eye_size/4), 
       OPEN);
  ...
  arc(eye_center, 
      colored_eye_centerY + shadow_Y - (2*anime_var/5),
  ...
  if(anime_var < eye_size/8){
    ellipse( eye_center - radius_X/2, 
             colored_eye_centerY - eye_size/4, 
             eye_size/10, eye_size/10);
    ellipse( eye_center + radius_X/2, 
             colored_eye_centerY + eye_size/6, 
  ...
  if(anime_var < eye_size/8)
  arc( eye_center, 
       colored_eye_centerY + eye_size/3 - anime_var/2, 
